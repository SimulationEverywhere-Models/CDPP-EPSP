...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  customer_service.o register.o service_activation.o service_activation_processor.o service_activation_q.o service_design.o service_design_processor.o service_design_q.o service_implementation.o service_implementation_processor.o service_implementation_q.o service_ready_q.o service_request_processor.o service_request_q.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#/
...
#^|
customer_service.o: /cygdrive/C/eclipse/workspace/zzepsp/customer_service.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/zzepsp/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_activation.o: /cygdrive/C/eclipse/workspace/zzepsp/service_activation.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_activation_processor.o: /cygdrive/C/eclipse/workspace/zzepsp/service_activation_processor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_activation_q.o: /cygdrive/C/eclipse/workspace/zzepsp/service_activation_q.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_design.o: /cygdrive/C/eclipse/workspace/zzepsp/service_design.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_design_processor.o: /cygdrive/C/eclipse/workspace/zzepsp/service_design_processor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_design_q.o: /cygdrive/C/eclipse/workspace/zzepsp/service_design_q.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_implementation.o: /cygdrive/C/eclipse/workspace/zzepsp/service_implementation.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_implementation_processor.o: /cygdrive/C/eclipse/workspace/zzepsp/service_implementation_processor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_implementation_q.o: /cygdrive/C/eclipse/workspace/zzepsp/service_implementation_q.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_ready_q.o: /cygdrive/C/eclipse/workspace/zzepsp/service_ready_q.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_request_processor.o: /cygdrive/C/eclipse/workspace/zzepsp/service_request_processor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
service_request_q.o: /cygdrive/C/eclipse/workspace/zzepsp/service_request_q.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
customer_service.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/customer_service.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/customer_service.h \
...
register.o: /cygdrive/C/eclipse/workspace/zzepsp/register.cpp \
 ...
 /cygdrive/C/eclipse/workspace/zzepsp/service_request_q.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_ready_q.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_request_processor.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_design_q.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_design_processor.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_implementation_q.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_implementation_processor.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_activation_q.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_activation_processor.h \
 /cygdrive/C/eclipse/workspace/zzepsp/customer_service.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_design.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_implementation.h \
 /cygdrive/C/eclipse/workspace/zzepsp/service_activation.h
service_activation.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_activation.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_activation.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/loader.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_activation_processor.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_activation_processor.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_activation_processor.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/loader.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_activation_q.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_activation_q.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_activation_q.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_design.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_design.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_design.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/loader.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_design_processor.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_design_processor.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_design_processor.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_design_q.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_design_q.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_design_q.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/loader.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_implementation.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_implementation.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_implementation.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/loader.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_implementation_processor.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_implementation_processor.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_implementation_processor.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/loader.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_implementation_q.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_implementation_q.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_implementation_q.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_ready_q.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_ready_q.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_ready_q.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/loader.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_request_processor.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_request_processor.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_request_processor.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
service_request_q.o: \
 /cygdrive/C/eclipse/workspace/zzepsp/service_request_q.cpp \
 /cygdrive/C/eclipse/workspace/zzepsp/service_request_q.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
